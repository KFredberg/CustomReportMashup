...
require.config({
  ...
  paths: {
    ...
    'Sortable': scriptsUrl + 'js/vendor/sortable/Sortable',
    'angular-sortable': scriptsUrl + 'js/vendor/sortable/ng-sortable',
    ...
    'controller.dynamic': scriptsUrl + 'js/controllers/dynamic',
...
define([
	...
	app.obj.angularApp.config(function($routeProvider,$locationProvider) {
		$routeProvider
			.when('/', { 
                templateUrl: scriptsUrl+"views/dynamic.html",
